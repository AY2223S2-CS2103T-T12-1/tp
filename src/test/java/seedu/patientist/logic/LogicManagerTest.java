...
import static seedu.patientist.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonPatientistStorage addressBookStorage =
                new JsonPatientistStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonPatientistIoExceptionThrowingStub
        JsonPatientistStorage addressBookStorage =
                new JsonPatientistIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
     ...
     */
    private static class JsonPatientistIoExceptionThrowingStub extends JsonPatientistStorage {
        private JsonPatientistIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
